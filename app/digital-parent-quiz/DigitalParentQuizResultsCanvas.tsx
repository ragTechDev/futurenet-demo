...
import { PHONE_IMAGE_URLS } from "./quizPersonas";
import type { QuizPersona } from "./quizTypes";

export default function DigitalParentQuizResultsCanvas(props: {
  canvasRef: RefObject<HTMLCanvasElement | null>;
  className?: string;
  active: boolean;
  topPersona: QuizPersona;
  isUnlocked: boolean;
  quizUrl: string;
}) {
  const { canvasRef, className, active, topPersona, isUnlocked, quizUrl } = props;
  ...
  useEffect(() => {
    ...
    void draw();
  }, [active, canvasRef, topPersona, isUnlocked, quizUrl]);
